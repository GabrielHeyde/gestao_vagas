package br.com.gabrielheyde.gestao_vagas.modules.Candidate.Controllers;

import org.springframework.web.bind.annotation.RequestMapping;
import org.springframework.web.bind.annotation.RestController;

import br.com.gabrielheyde.gestao_vagas.modules.Candidate.CandidateEntity;
import br.com.gabrielheyde.gestao_vagas.modules.Candidate.DTO.ProfileCandidateResponseDTO;
import br.com.gabrielheyde.gestao_vagas.modules.Candidate.useCases.ApplyJobCandidateUseCase;
import br.com.gabrielheyde.gestao_vagas.modules.Candidate.useCases.CreateCandidateUserCases;
import br.com.gabrielheyde.gestao_vagas.modules.Candidate.useCases.ListAllJobsByFilterUseCase;
import br.com.gabrielheyde.gestao_vagas.modules.Candidate.useCases.ProfileCandidateUseCase;
...
public class CandidateController {
    ...
    @Autowired
    private CreateCandidateUserCases createCandidateUserCases;
    ...
    @Operation(
        ...
        description = "Essa função é responsável por cadastrar as informações do perfil do candidato."
    )
    @ApiResponses({
        @ApiResponse(
            responseCode = "200",
    ...
    public ResponseEntity<Object> create(@Valid @RequestBody CandidateEntity candidateEntity) {
        try {
            var result = this.createCandidateUserCases.execute(candidateEntity);
